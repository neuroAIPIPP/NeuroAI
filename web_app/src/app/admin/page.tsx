...
export default function AdminLandingPage() {
  ...
  return (
    <main className="min-h-screen relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-4">
              <Link href={isLoggedIn ? '/admin/dashboard' : '/login'}>
                <button className="px-10 py-5 bg-white text-[#8EACCD] rounded-2xl font-bold shadow-xl hover:bg-gray-100 transition-all flex items-center gap-2 group cursor-pointer">
                  {isLoggedIn
              ...
              <Link href={isLoggedIn ? '/admin/history' : '/login'}>
                <button className="px-10 py-5 bg-transparent border-2 border-white text-white rounded-2xl font-bold shadow-xl hover:bg-white/10 transition-all flex items-center gap-2 group cursor-pointer">
      ...
      {/* Footer */}
      <footer className="py-12 bg-white border-t border-[#8EACCD]/10 rounded-t-[10px]">
